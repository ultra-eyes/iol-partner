const CONFIG = {
    ...
    // --- クリニック情報 ---
    clinic: {
        name: 'Ultra Eyes Clinic',
        subtitle: 'IOL Navi',
        exportFilename: 'UltraEyes_IOL診断_結果',
        shareTitle: 'Ultra Eyes Clinic IOL診断結果',
        resultFooter: 'Ultra Eyes Clinic IOL Navi',
